...
const Auth: React.FC = () => {
  ...
  useEffect(() => {
    const accessTokenParams: string | null = new URLSearchParams(
  ...
  const buildSpotifyLinkAuthorize: () => string = () => {
    ...
    // const hostNmae = window.location.hostname;
  ...
  return (
    <main>
      <Box className="center" bg="black" gap={2}>
        <Image src="./spotify_logo.png" h={64} />

        <Link
          href={buildSpotifyLinkAuthorize()}
